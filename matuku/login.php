...
<html lang="en">
  ...
  <body>
    ...
    $query_user = mysqli_query($koneksi, "SELECT * FROM pemakai WHERE username='$user' AND password ='$password'");
 //SELECT * FROM pemakai WHERE username='abc' OR 1=1 -- ' AND password ='xxx';
